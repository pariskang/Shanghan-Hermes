...
TASK_TYPES: Dict[str, Dict] = {
    ...
    "perspectives": {"desc": "多觀點論證（七解釋範式+爭議仲裁）",
                     "tools": ["shanghan_perspectives", "shanghan_get_clause",
                               "shanghan_divergence_atlas"]},
    "provenance": {"desc": "深度溯源（知識生命史：源頭→異文→注家→後世→現代映射）",
                   "tools": ["shanghan_provenance", "shanghan_variants",
                             "shanghan_divergence_atlas"]},
    "correspondence": {"desc": "方證對應綜合推理（病機/治法/多維評分/類方/分級）",
                       "tools": ["shanghan_correspondence", "shanghan_differential",
                                 "shanghan_search"]},
    "herb": {"desc": "單味藥藥解（性味/功效/內證統計/配伍/安全）",
             "tools": ["shanghan_herb", "shanghan_search"]},
    "formula_explain": {"desc": "方解/君臣佐使/配伍邏輯/方劑知識卡",
                        "tools": ["shanghan_formula_explain", "shanghan_herb",
                                  "shanghan_search"]},
    "decoction": {"desc": "煎服法（方後原文規則化）",
                  "tools": ["shanghan_decoction", "shanghan_formula_rule"]},
