...
_KIND_PATTERNS = [
    ...
    ("case", r"醫案|案例|實驗錄|診案"),
    ("perspectives", r"怎麼理解|如何理解|多觀點|學派(觀點|解釋|比較)|觀點論證"),
    ("provenance", r"知識生命史|生命史|傳播路徑|傳播鏈|引文溯源|知識演化|"
                   r"知識譜系|後世如何(引用|化用|發揮)|現代論文如何"),
    ("correspondence", r"方證對應|辨證分析|病機(結構|分析)|屬何證|什麼證候"),
    ("decoction", r"煎服|煎法|服法|先煮|後下|烊化|啜粥"),
    ("formula_explain", r"方解|方義|君臣佐使|配伍|組方|知識卡"),
    ("herb", r"藥解|性味|歸經|單味藥?"),
